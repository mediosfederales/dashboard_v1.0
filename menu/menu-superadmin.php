...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Nav Item - Onboarding -->
            <li class="nav-item">
                <a class="nav-link" href="onboarding_step1.php">
                    <i class="fas fa fa-ship"></i>
                    <span>Onboarding</span></a>
            </li>
            ...
            <li class="nav-item">
                <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFour"
                    ...
                    <span>Vistas roles</span>
                </a>
                <div id="collapseFour" class="collapse" aria-labelledby="headingUtilities"
                    data-parent="#accordionSidebar">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="view-publisher.php">Vista publisher</a>
                        <a class="collapse-item" href="view-billing-publisher.php">Publisher - Billing</a>
                        <a class="collapse-item" href="view-blockcontrol-publisher.php">Publisher - Bloqueos</a>
                        <a class="collapse-item" href="adserver.php">Publisher - Adserver</a>
                        <a class="collapse-item" href="video-player.php">Publisher - Video player</a>
                    </div>
                </div>
            </li>
