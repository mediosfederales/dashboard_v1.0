...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <li class="nav-item">
                ...
                <div id="collapseTwo" class="collapse" aria-labelledby="headingUtilities"
                    ...
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="adserver.php">Adserver</a>
                        <a class="collapse-item" href="video-player.php">Video Player</a>
                    </div>
                </div>
            </li>
            ...
            <!-- Nav Item - Asistente de Implementación -->
            <li class="nav-item">
                <a class="nav-link" href="asistente-implementacion.php">
                    <i class="fas fa-fw fa-cog"></i>
                    <span>Asistente de Implementación</span></a>
            </li>
