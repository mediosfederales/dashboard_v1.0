        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div>
                    ...
                    <div class="row">
                        <!-- Render 'KPI ANALYTICS' Datastudio Dashboard iframe based on Authentication & site_hashed using php -->
                        
            
                        <?php

                        $analytics_sites_ifr = '<iframe width="100%" height="3200px" src="https://datastudio.google.com/embed/reporting/82bfedce-2ce4-4353-b924-357fbaa65783/page/p_7chtw1bb6c" frameborder="0" style="border:0" allowfullscreen></iframe>';
                        
                        echo $analytics_sites_ifr;
