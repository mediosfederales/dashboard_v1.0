        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div>
                    ...
                    <div class="row">
                        <!-- Render 'KPI PERFORMANCE - PUBLISHER > Score' Datastudio Dashboard iframe based on Authentication & site_hashed using php -->
                        
            
                        <?php

                        $activity_ifr = '<iframe width="100%" height="900" src="https://datastudio.google.com/embed/reporting/350d7dfc-65a6-4756-994e-a686750d4baf/page/p_h8mcysq6zc" frameborder="0" style="border:0" allowfullscreen></iframe>';
