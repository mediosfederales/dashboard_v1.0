            ...
            <div id="content">
                ...
                <div>
                    ...
                    <div>
                        ...
                        <!-- Render 'BILLING - PUBLISHER' Datastudio Dashboard iframe based on Authentication & site_hashed using php -->
                        
                        <!-- Billing dashboard -->
                        <div>
            
                            <?php include 'permissions/billing-permissions.php';?>
                                    
                        </div>
                        
                        
                        
                    <!--<iframe id="billing-publisher" width="100%" height="900" frameborder="0" src=""></iframe>   -->
