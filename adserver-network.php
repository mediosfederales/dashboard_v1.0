                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card position-relative">
                                ...
                                <div class="card-header py-3" style="text-align:center;">
                                    <p class="mb-0" style="color:#000;">Maneja tu inventario con un <b>Adserver 360</b> y con&eacute;ctate a <b>Header Bidding.</b><br>Accede a las mejores Exchanges de publicidad, y maximiza los ingresos program&aacute;ticos.<br>&#161;Cont&aacute;ctate con nosotros!</b></p>
                                    <br>
                                    <div class="dropdown mb-4">
                                        <a href="https://mediosfederales.com/contacto/" target="_blank">
                                            ...
                                            aria-expanded="false">
                                            Implementar el Adserver&nbsp;&nbsp;&nbsp;<i class="fa fa-arrow-right" aria-hidden="true"></i>
                                        </button>
                                        </a>
