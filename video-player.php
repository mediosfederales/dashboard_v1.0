                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="card position-relative">
                                ...
                                <div class="card-header py-3" style="text-align:center;">
                                    <p class="mb-0" style="color:#000;">Haga click en el siguiente enlace para acceder al Video Player.<br>Recuerde su usuario y contraseña para ingresar. Si aún no lo tiene, solicítelo a <b>soporte@mediosfederales.com</b></p>
                                    <br>
                                    <div class="dropdown mb-4">
                                        <a href="https://platform.showheroes.com/app/accounts/login/" target="_blank">
                                            ...
                                            aria-expanded="false">
                                            Ir al Player&nbsp;&nbsp;&nbsp;<i class="fa fa-arrow-right" aria-hidden="true"></i>
                                        </button>
                                        </a>
